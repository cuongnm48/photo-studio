...
const photoIds = [
  {
    id: 4333,
    image_url: "https://res.cloudinary.com/dgsn0xio7/image/upload/f_auto,q_auto:best,w_387,h_516/v1745637914/banner-homepage/test_sr1i4y.png",
...
export default function Banner() {
  return (
    <section aria-label="Studio Introduction" className="relative w-full overflow-hidden">
      ...
      <div className="relative w-full h-[600px] md:h-[600px]">
        ...
        <Image
          ...
          alt="Nhật Studio - Professional Photography Services"
          fill
          priority
        ...
        <div className="max-w-7xl w-full mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="text-center md:text-left md:max-w-xl">
              ...
              <Link
                href="tel:0909939351"
                aria-label="Đặt lịch chụp ảnh - Gọi 0909939351"
            ...
            {/* Photo cards */}
            <div className={cn("grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4", "w-full max-w-md md:max-w-xl")} role="grid">
              {photoIds.map((photo, index) => (
                ...
                >
                  <Image
                    src={photo.image_url}
                    alt={photo.alt || `Mẫu ảnh chụp ${index + 1} tại Nhật Studio`}
                    fill
                    priority
                    quality={85}
                    className="object-cover"
